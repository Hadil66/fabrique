...
<div class="error-page">
    ...
    <defs>
      <g class="name" fill="currentColor" id="logo-en">
				...
				<path d="M46.4 33.1c-23.1 0-41.8 18.8-41.8 41.8 0 23.1 18.8 41.8 41.8 41.8 23.1 0 41.8-18.8 41.8-41.8 0-23.1-18.8-41.8-41.8-41.8z"
	        fill="#79aafa">
        </path>
...
<style>
  ...
  path:nth-child(4) {
    animation: fade4 5s ease-in-out infinite;
    animation-delay: 0s;
  } 
</style>
